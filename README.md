...
| [**FastAPI Banking**](https://github.com/ademarbarreto/api_bancaria) | API bancária com autenticação JWT (PyJWT 2.x), bcrypt, passlib — desenvolvida em WSL/Ubuntu com resolução de breaking changes. | `FastAPI` `JWT` `Python` `WSL` |
