...
| **Agente de Organização de Tarefas com Google ADK + Trello** | Agente de IA que organiza e gerencia tarefas integrando o Google ADK ao Trello, com resolução de bugs de serialização, fuso horário e cotas de API. | `Google ADK` `Trello API` `Python` |
